...
// rl_bridge.c — RL interface globals
extern int RL_state;
extern int rl_headless;
extern int rl_request_restart_level;
extern uint64_t pop_frame_counter;
extern int rl_speed_multiplier;
